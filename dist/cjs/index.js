...
class BimapMixed {
     ...
     */
    add(left, right) {
        tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").set(left, right);
        tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").set(right, left);
        return this;
    }
    delete(key, hint) {
        let has = false;
        ...
        if (hint == 'left') {
            keyLeft = key;
            has = tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").has(keyLeft);
            keyRight = tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").get(keyLeft);
        }
        else if (hint == 'right') {
            keyRight = key;
            has = tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").has(keyRight);
            keyLeft = tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").get(keyRight);
        }
        else {
            if (tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").has(key)) {
                keyLeft = key;
                has = true;
                keyRight = tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").get(keyLeft);
            }
            else if (tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").has(key)) {
                keyRight = key;
                has = true;
                keyLeft = tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").get(keyRight);
            }
        ...
        if (has) {
            tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").delete(keyLeft);
            tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").delete(keyRight);
        }
        return has;
    }
    has(key, hint) {
        if (hint === 'left')
            return tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").has(key);
        if (hint === 'right')
            return tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").has(key);
        return tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").has(key) || tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").has(key);
    }
    get(key, hint) {
        if (hint === 'left')
            return tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").get(key);
        if (hint === 'right')
            return tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").get(key);
    ...
    clear() {
        tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").clear();
        tslib.__classPrivateFieldGet(this, _BimapMixed_implRight, "f").clear();
    }
    entries() {
        return tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").entries();
    }
    forEach(callbackfn) {
        return tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").forEach((value, key) => { return callbackfn(key, value, this); });
    }
    get size() {
        return tslib.__classPrivateFieldGet(this, _BimapMixed_implLeft, "f").size;
    }
}
