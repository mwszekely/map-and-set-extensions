...
type ValueFromRecursiveMap<M> = (M extends Map<infer K, infer RM> ? ValueFromRecursiveMap<RM> : M extends Set<infer T> ? T : M)

function mapGetRecursive<M extends Map<any, any>>(map: M, ...keys: KeysFromRecursiveMap<M>): ValueFromRecursiveMap<M> | undefined {
